...
<%@ include file="../../include/include/pathInclude.jsp" %>
...
$(document).ready(function(){
	...
	$("#up_go").click(function(){
		...
		location.href="../qnaList/qnaUpdateSub.hon?qna_no="+no
	
	});
	
	$("#de_go").click(function(){
	alert(no + id);
		location.href='../qnaList/qnaDelete.hon?no='+no+"&id="+id;
	});
...
<br>
<div align="center">
<img src="/sp-Honjaopseoye/notice/qna/logo.png" width="800px" height="200px">
</div>
<br>
<br>
<br>
...
<!-- 목록 -->
<button class="positive ui button" id="up_go" name="up_go" style="width:100px;">수정</button>
<button class="positive ui button" id="de_go" name="de_go" style="width:100px;">삭제</button>
<br>
<!-- 목록 -->
</td>
</tr>
...
<td align="center">
&nbsp;&nbsp;&nbsp;&nbsp;
<button class="positive ui button" id="bab_reply" name="bab_reply" style="width:100px;">답변</button>
</td>
</tr>
</table>
