...
<form id="f_matjip" name="f_matjip" method="POST" action="../store/add/matjip.test">
		...
		<div class="ui labeled input" style="width:100%;">
  			...
  			<input type="text" id="store_name" name="store_name" placeholder="ex)가산동 가산코인노래방">
		</div>
		<!-- ============================가게 이름 등록 끝========================== -->
		<div class="ui divider"></div>
		<!-- ==============================가게 전화번호 등록======================= -->
		...
		<div class="ui dropdown" id="store_business" name="store_business">
 			<input type="hidden"  name="store_business">
  			...
  			<div class="menu">
    			<div class="item" data-value="2300">카페</div>
    			<div class="item" data-value="2301">노래방</div>
    			<div class="item" data-value="2302">PC방</div>
    			<div class="item" data-value="2303">보드게임</div>
    			<div class="item" data-value="2304">당구장</div>
    			<div class="item" data-value="2305">만화방</div>
    			<div class="item" data-value="2306">볼링장</div>
    			<div class="item" data-value="2307">스크린야구</div>
    			<div class="item" data-value="2308">기타</div>
  			</div>
		</div>
		<!-- ============================음식 종류 등록 끝============================ -->
		<div class="ui divider"></div>
		...
		<div class="ui dropdown" id="store_price" name="store_price">
 			<input type="hidden" name="store_price">
  			...
  			<div class="menu">
    			...
    			<div class="item" data-value="만원~2만원">2만원~4만원</div>
    			<div class="item" data-value="4만원~6만원">4만원~6만원</div>
    			<div class="item" data-value="6만원~8만원">6만원~8만원</div>
    			<div class="item" data-value="8만원~10만원">8만원~10만원</div>
    			<div class="item" data-value="10만원~">10만원~</div>
  			</div>
		</div>
		<!--================================ 가격대 등록 끝========================= -->		
		<div class="ui divider"></div>
		...
		<div class="ui labeled input" style="width:100%;">
  			...
  			<input type="text" placeholder="ex)안주가 맛있는 집" id="store_introduce" name="store_introduce">
		</div>
		<!--===============================가게 한줄소개 등록 끝=======================  -->
		<div class="ui divider"></div>
		<!-- =============================가게 홈페이지 주소 등록========================= -->
		...
		<div class="ui labeled input" style="width:100%;">
  			...
  			<input type="text" placeholder="ex)삼구포차 삼구 가산동 가산 가산동술집" id="store_keyword" name="store_keyword">
		</div>
		<!-- =============================가게 검색 키워드 등록 끝========================= -->
