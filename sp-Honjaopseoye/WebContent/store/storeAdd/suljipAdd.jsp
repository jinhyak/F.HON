...
<form id="f_matjip" name="f_matjip" method="POST" action="../store/add/matjip.test">
		...
		<div class="ui labeled input" style="width:100%;">
  			...
  			<input type="text" id="store_name" name="store_name" placeholder="ex)가산동 삼구포차">
		</div>
		<!-- ============================가게 이름 등록 끝========================== -->
		<div class="ui divider"></div>
		<!-- ==============================가게 전화번호 등록======================= -->
		...
		<div class="ui dropdown" id="store_business" name="store_business">
 			<input type="hidden"  name="store_business">
  			...
  			<div class="menu">
    			<div class="item" data-value="2200">포차</div>
    			<div class="item" data-value="2201">호프</div>
    			<div class="item" data-value="2202">바</div>
    			<div class="item" data-value="2203">선술집</div>
    			<div class="item" data-value="2204">이자카야</div>
    			<div class="item" data-value="2205">기타</div>
  			</div>
		</div>
		<!-- ============================음식 종류 등록 끝============================ -->
		<div class="ui divider"></div>
		...
		<div class="ui dropdown" id="store_price" name="store_price">
 			<input type="hidden" name="store_price">
  			...
  			<div class="menu">
    			<div class="item" data-value="~2만원">~2만원</div>
    			<div class="item" data-value="2만원~4만원">2만원~4만원</div>
