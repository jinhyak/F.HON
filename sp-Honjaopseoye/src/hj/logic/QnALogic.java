...
public class QnALogic {
	...
	// QnA 전체 게시글 조회 Logic
	public List<Map<String, Object>> qnaBoardListLogic()
	...
	public int qnaBoardInsertLogic(Map<String, Object> pMap) 
			throws ServletException, IOException {
	...
	// QnA 게시글 DELETE Logic
		public int qnaBoardDeleteLogic(Map<String, Object> pMap) 
				throws ServletException, IOException {
		...
		public int qnaBoardUpdateLogic(Map<String, Object> pMap) 
				throws ServletException, IOException {
